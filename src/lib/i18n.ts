...
export const T = {
  ...
  parentWriteDifficulty:  { ja: 'かく むずかしさ',                     zh: '書寫難易度' },
  parentWriteDiff1:       { ja: 'Lv1: もじを なぞる',                  zh: 'Lv1：描字（有範本）' },
  parentWriteDiff2:       { ja: 'Lv2: そらで かく',                    zh: 'Lv2：空寫（無範本）' },
  parentWriteDiff3:       { ja: 'Lv3: ことばを かく',                  zh: 'Lv3：寫詞語' },
  kanaCatchNext:          { ja: 'つぎへ →',                            zh: '下一題 →' },
